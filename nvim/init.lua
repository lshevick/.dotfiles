...
function SaveStage()
    ...
    local remote = "lshevick@minibox"
    local admin_remote_base_dir = "/var/www/admin_dashboard"
    local remote_file = ''
    local_dir = escape_pattern(local_dir)

    if string.find(local_dir, "dashboard") then
...
require('luasnip').filetype_extend("html", {'html', 'css', 'javascript'})
...
require('mason-lspconfig').setup({
  ensure_installed = {'eslint', 'html', 'phpactor', 'tailwindcss', 'gopls'},
  handlers = {
...
require("conform").setup({
  ...
  formatters_by_ft = {
    ...
    go = {'gofmt', 'goimports'},
    html = {'djlint', 'eslint_d', 'html_beautify'}
  },
})
